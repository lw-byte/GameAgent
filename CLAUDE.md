...
This project is indexed by GitNexus as **SmartPerfetto** (49644 symbols, 149358 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
